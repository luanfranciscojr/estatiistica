...
const _chalk = /*#__PURE__*/ _interop_require_default(__webpack_require__(9633));
...
const _utils = __webpack_require__(2114);
...
const _requestcookies = __webpack_require__(2288);
const _headers = __webpack_require__(7423);
const _cookies = __webpack_require__(9553);
const _requestasyncstorage = __webpack_require__(2311);
const _actionasyncstorage = __webpack_require__(6071);
const _staticgenerationbailout = __webpack_require__(6213);
const _draftmode = __webpack_require__(5245);
function headers() {
...
let chalk;
if (false) {} else {
    chalk = __webpack_require__(6827);
}
...
const _headers = __webpack_require__(7423);
const _constants = __webpack_require__(6121);
function getCookieParser(headers) {
    return function parseCookie() {
        ...
        const { parse: parseCookieFn } = __webpack_require__(1882);
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(1882);
...
const _apiutils = __webpack_require__(3184);
...
const _approuterheaders = __webpack_require__(9913);
const _headers = __webpack_require__(7423);
const _requestcookies = __webpack_require__(2288);
const _cookies = __webpack_require__(9553);
const _draftmodeprovider = __webpack_require__(2022);
...
const _http = __webpack_require__(6337);
const _responsehandlers = __webpack_require__(6325);
...
const _nexturl = __webpack_require__(9440);
const _cleanurl = __webpack_require__(3229);
...
const _notfound = __webpack_require__(6242);
const _redirect = __webpack_require__(9846);
const _responsehandlers = __webpack_require__(6325);
...
const _routemodule = __webpack_require__(5369);
const _requestasyncstoragewrapper = __webpack_require__(5074);
const _staticgenerationasyncstoragewrapper = __webpack_require__(5759);
const _responsehandlers = __webpack_require__(6325);
const _http = __webpack_require__(6337);
const _patchfetch = __webpack_require__(435);
const _tracer = __webpack_require__(5472);
const _constants = __webpack_require__(5954);
const _getpathnamefromabsolutepath = __webpack_require__(2065);
const _proxyrequest = __webpack_require__(9131);
const _resolvehandlererror = __webpack_require__(4448);
const _log = /*#__PURE__*/ _interop_require_wildcard(__webpack_require__(4500));
const _autoimplementmethods = __webpack_require__(1187);
const _getnonstaticmethods = __webpack_require__(9542);
const _requestcookies = __webpack_require__(2288);
const _routekind = __webpack_require__(119);
const _parsedurlquerytoparams = __webpack_require__(8309);
...
const _constants = __webpack_require__(5954);
const _tracer = __webpack_require__(5472);
const _constants1 = __webpack_require__(6121);
...
const _detectdomainlocale = __webpack_require__(4334);
const _formatnextpathnameinfo = __webpack_require__(8585);
const _gethostname = __webpack_require__(9074);
const _getnextpathnameinfo = __webpack_require__(2300);
...
const _detectdomainlocale = __webpack_require__(7280);
const _formatnextpathnameinfo = __webpack_require__(9687);
const _gethostname = __webpack_require__(333);
const _getnextpathnameinfo = __webpack_require__(7311);
const REGEX_LOCALHOST_HOSTNAME = /(?!^https?:\/\/)(127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|\[::1\]|localhost)/;
function parseURL(url, base) {
    return new URL(String(url).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"), base && String(base).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"));
}
...
const _reflect = __webpack_require__(353);
...
const _cookies = __webpack_require__(9484); //# sourceMappingURL=cookies.js.map
...
const _cookies = __webpack_require__(6092); //# sourceMappingURL=cookies.js.map
...
const _nexturl = __webpack_require__(74);
const _utils = __webpack_require__(9481);
const _error = __webpack_require__(4973);
const _cookies = __webpack_require__(625);
...
const _uaparserjs = /*#__PURE__*/ _interop_require_default(__webpack_require__(9286));
function _interop_require_default(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
    };
...
const _addpathprefix = __webpack_require__(2782);
const _pathhasprefix = __webpack_require__(7712);
function addLocale(path, locale, defaultLocale, ignorePrefix) {
    // If no locale was given or the locale is the default locale, we don't need
    // to prefix the path.
    if (!locale || locale === defaultLocale) return path;
...
const _parsepath = __webpack_require__(7576);
function addPathPrefix(path, prefix) {
    if (!path.startsWith("/") || !prefix) {
        return path;
    }
...
const _removetrailingslash = __webpack_require__(1438);
const _addpathprefix = __webpack_require__(2782);
const _addpathsuffix = __webpack_require__(5506);
const _addlocale = __webpack_require__(5443);
function formatNextPathnameInfo(info) {
    let pathname = (0, _addlocale.addLocale)(info.pathname, info.locale, info.buildId ? undefined : info.defaultLocale, info.ignorePrefix);
    if (info.buildId || !info.trailingSlash) {
        pathname = (0, _removetrailingslash.removeTrailingSlash)(pathname);
...
const _normalizelocalepath = __webpack_require__(687);
const _removepathprefix = __webpack_require__(2586);
const _pathhasprefix = __webpack_require__(3055);
...
const _normalizelocalepath = __webpack_require__(9042);
const _removepathprefix = __webpack_require__(3062);
const _pathhasprefix = __webpack_require__(7712);
function getNextPathnameInfo(pathname, options) {
    var _options_nextConfig;
    const { basePath, i18n, trailingSlash } = (_options_nextConfig = options.nextConfig) != null ? _options_nextConfig : {};
...
const serverExports = {
    NextRequest: (__webpack_require__(2373).NextRequest),
    NextResponse: (__webpack_require__(8466)/* .NextResponse */ .x),
    ImageResponse: (__webpack_require__(3891)/* .ImageResponse */ .E),
    userAgentFromString: (__webpack_require__(3117).userAgentFromString),
    userAgent: (__webpack_require__(3117).userAgent)
};
